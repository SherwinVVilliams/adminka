...
function serviceKatalogForms() {
    $(".brif-popUp6 form").aSendForm({
        popup: [".brif-popUp6", ".service-katalog-block1 .container .brif-popUp6-button"],
        goal: goal,
        ...
        onClickPopup: function() {
            $(".brif-popUp6").addClass("katalog"), buttonText = $(this).text(), title = $(".service .container h2").text()
        },
