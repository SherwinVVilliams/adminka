...
//		echo "Вашая заявка принята.<br> Мы свяжемся с Вами в ближайшее время";
//	}else{
...
//	$to  = $_POST['art_mail_to'];
    $to  = "kalinka03333@gmail.com";
    // тема письма
